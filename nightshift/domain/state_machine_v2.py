"""Nightshift state machine v2 (pressure-driven).

Frozen decision (docs/gap-analysis-v2.md §1.6):
...
must instantiate a single `StateMachineV2` and call `evaluate` from either
the pressure adapter callback or a low-rate tick loop.
"""
